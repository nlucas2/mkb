//! Timestamp helpers: the single place that knows mkb's on-the-wire time format.
//!
//! mkb represents times as **RFC 3339 in UTC at second precision** (`2026-06-24T02:30:00Z`).
