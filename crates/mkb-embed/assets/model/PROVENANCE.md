...
384-dimensional), vendored into the repository and compiled into the `mkbd` daemon via
`include_bytes!` (the `vendored-model` feature, on by default). They give mkb fully offline,
